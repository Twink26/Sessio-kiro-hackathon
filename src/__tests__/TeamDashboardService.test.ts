...
describe('TeamDashboardService', () => {
  ...
  let mockTeamDataAggregator: jest.Mocked<ITeamDataAggregator>;
  let mockTeamDashboardProvider: jest.Mocked<ITeamDashboardProvider>;
  ...
  beforeEach(() => {
    ...
    teamDashboardService = new TeamDashboardService(
      mockTeamDataAggregator,
      mockTeamDashboardProvider,
      mockOutputChannel
    );
