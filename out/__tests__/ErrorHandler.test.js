...
describe('ErrorHandler', () => {
    ...
    beforeEach(() => {
        ...
        errorHandler = new ErrorHandler_1.ErrorHandler(mockLoggingService);
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    describe('Storage Error Handling', () => {
        it('should handle file not found error', () => {
            ...
            expect(result.recoveryAction).toBe(ErrorHandler_1.RecoveryAction.FALLBACK);
        ...
        it('should handle permission denied error', () => {
            ...
            const result = errorHandler.handleStorageError(error, context);
            expect(result.handled).toBe(true);
            expect(result.recoveryAction).toBe(ErrorHandler_1.RecoveryAction.USER_ACTION_REQUIRED);
    ...
    describe('Git Error Handling', () => {
        it('should handle not a git repository error', () => {
            ...
            expect(result.handled).toBe(true);
            expect(result.recoveryAction).toBe(ErrorHandler_1.RecoveryAction.DISABLE_FEATURE);
        ...
        it('should handle git timeout error', () => {
            ...
            const result = errorHandler.handleGitError(error, context);
            expect(result.handled).toBe(true);
            expect(result.recoveryAction).toBe(ErrorHandler_1.RecoveryAction.RETRY);
    ...
    describe('User Messages', () => {
        ...
        it('should show error message with actions', () => {
            ...
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith('Test error message', ...actions);
        });
