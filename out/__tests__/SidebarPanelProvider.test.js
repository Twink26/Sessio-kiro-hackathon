...
describe('SidebarPanelProvider', () => {
    ...
    beforeEach(() => {
        ...
        provider = new SidebarPanelProvider_1.SidebarPanelProvider(extensionUri);
        mockWebview = {
            html: '',
            options: {},
    ...
    describe('message handling', () => {
        it('should handle error click messages', () => {
            ...
            expect(vscode.window.showInformationMessage).toHaveBeenCalledWith('Terminal Error Details', { modal: false, detail: 'Test error message' });
        });
...
//# sourceMappingURL=SidebarPanelProvider.test.js.map