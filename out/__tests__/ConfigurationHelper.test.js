...
describe('ConfigurationHelper', () => {
    ...
    beforeEach(() => {
        ...
        ConfigurationService_1.ConfigurationService.mockImplementation(() => mockConfigService);
        // Reset singleton instance
        ConfigurationHelper_1.ConfigurationHelper.instance = undefined;
        configHelper = ConfigurationHelper_1.ConfigurationHelper.getInstance();
    });
    afterEach(() => {
    ...
    describe('singleton pattern', () => {
        it('should return the same instance', () => {
            const instance1 = ConfigurationHelper_1.ConfigurationHelper.getInstance();
            const instance2 = ConfigurationHelper_1.ConfigurationHelper.getInstance();
...
//# sourceMappingURL=ConfigurationHelper.test.js.map