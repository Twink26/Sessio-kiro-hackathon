...
describe('FileChangeMonitor', () => {
    ...
    beforeEach(() => {
        ...
        vscode.workspace.asRelativePath.mockImplementation((uri) => uri.path || uri);
        // Create new instance
        fileChangeMonitor = new FileChangeMonitor_1.FileChangeMonitor();
    });
    afterEach(() => {
...
//# sourceMappingURL=FileChangeMonitor.test.js.map